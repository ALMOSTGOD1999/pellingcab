...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "PellingCab is a premium chauffeur-driven car rental service across India." },
    ],
  }),
  component: About,
});
  ...
  return (
    <PageShell title="About PellingCab" subtitle="A quiet obsession with great rides.">
      <div className="max-w-3xl space-y-6 text-muted-foreground">
        <p>
          PellingCab was built for travellers who care about the details — a spotless cabin, a chauffeur
          who knows the city, a price that doesn't change on you. We operate a hand-picked fleet of
          premium SUVs and sedans across India, driven by professionals we've trained ourselves.
        </p>
