  ...
  head: () => ({
    meta: [
      { title: "PellingCab · Shared shuttle & premium chauffeur travel" },
      {
        name: "description",
        content:
          "Book a seat on scheduled inter-city shuttles or rent a chauffeured luxury car half-day / full-day across India.",
      },
      ...
      <main className="animate-float-up">
        ...
        <section className="relative overflow-hidden grain">
          ...
          <div className="relative mx-auto max-w-6xl px-4 sm:px-6 pt-16 pb-20 sm:pt-24 sm:pb-28">
            ...
            <p className="mt-5 max-w-xl text-base sm:text-lg text-muted-foreground">
              {t.tagline} Scheduled shuttles between Pelling and Bagdogra Airport — or rent a
              private cab for the day.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-6 text-xs text-muted-foreground">
              <span className="inline-flex items-center gap-1.5">
                <Star className="h-3.5 w-3.5 fill-primary text-primary" /> 4.9 · 12k+ trips
              </span>
              <span className="inline-flex items-center gap-1.5">
                <Shield className="h-3.5 w-3.5 text-primary" /> Verified chauffeurs
              </span>
              <span className="inline-flex items-center gap-1.5">
                <Sparkles className="h-3.5 w-3.5 text-primary" /> Sanitised cabins
              </span>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-4 sm:px-6 py-16">
          <div className="flex items-end justify-between gap-4 mb-6">
            ...
            <Link
              to="/shuttle"
              className="text-sm text-muted-foreground hover:text-primary hidden sm:inline-flex items-center gap-1"
            >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {featured.map((r) => (
              <Link
                ...
                onClick={() => {
                  setMode("shuttle");
                  setShuttle({ routeId: r.id, departure: "" });
                }}
              ...
              >
                ...
                <div className="mt-4 flex items-end justify-between">
                  ...
                  <span className="gold-text text-xl font-semibold">
                    ₹{r.pricePerSeat.toLocaleString("en-IN")}
                  </span>
                </div>
              </Link>
            ))}
        ...
        <section className="mx-auto max-w-6xl px-4 sm:px-6 pb-16">
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              {
                t: "Transparent fares",
                d: "See taxes and totals before you pay. No surge, no surprises.",
              },
              {
                t: "Live tracking",
                d: "Watch your shuttle arrive in real time with our status timeline.",
              },
              {
                t: "24/7 concierge",
                d: "Talk to a real person any hour of the day, in English or Hindi.",
              },
            ].map((f) => (
